...
<style>
    ...
    <section class="section1">
        <section class="receipt">
            ...
            <div class="line"></div>
            <div class="row"><span>Transaction Type</span><span>Deposit</span></div> 
            <div class="row"><span>Gateway</span><span>Bank Transfer</span></div>
            ...
            <div class="line"></div>
            <hr> 
            <div class="row"><b>Amount</b><b>&#8358;{{ number_format($amount,2) }}</b></div>
            <div class="row"><span>Fee</span><span>&#8358;0.00</span></div>
            <hr>
            <div class="row"><b>Total</b><b>&#8358;{{ number_format($amount,2) }}</b></div>
            <div class="barcode">{{ $uniqid }}</div>
            <span class="dark" style="text-align:center;padding:20px;">Pending deposits may take 1-3 hrs depending on the network of the bank used in making transfer</span>
